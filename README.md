...
Current local validation: proxy **1133/1133**; playground **1369/1369**, lint clean, and `vite build` clean; Pulse PBI enabler **87/87**, lint clean, and local `pbiviz package` clean from the 2026-05-21 integrity sweep.
