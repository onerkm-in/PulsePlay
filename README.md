...
Current local validation: proxy **1077/1077** from the 2026-05-21 PX1 handover; playground **1273/1273**, lint clean, and `vite build` clean from the 2026-05-21 G2 handover.
