...
export const GROUP_LEAF_LABELS: Record<SettingsGroupId, string[]> = {
    ...
    ai: ["Provider", "Model / Agent", "Knowledge pack", "Knowledge Base", "Vector Search KB", "Connection test", "Power BI Q&A", "Response behavior", "Supervisor Fusion", "UC Metric View", "Browse library"],
    preferences: [
        "UI mode",
        "Layout preset",
        "Visible panels",
