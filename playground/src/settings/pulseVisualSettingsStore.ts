...
const DEFAULTS: PulseAiVisualSettings = {
    ...
    // Per-card "Generated by PulsePlay · Source: … · Updated …" provenance
    // footer is developer/QA chrome that confuses end users — hidden by
    // default; authors can re-enable it via Settings → AI → Response behavior.
