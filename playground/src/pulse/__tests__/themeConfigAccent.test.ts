...
// dark-canonical steel #7fa3c9, leaving low-contrast accent text/links. The resolver
...
describe("buildAppThemeVars — dark accent (A3)", () => {
    ...
    it("uses the dark-canonical accent (#7fa3c9) for a built-in preset in dark mode", () => {
        ...
        expect(vars["--pp-accent-soft"]).toContain("127, 163, 201");
    });
