...
description: Renderer-only native BI adapter architecture locked 2026-05-21; G3 governance route attestations and native fail-closed gate shipped; G4 native canvas is next
type: feature
