...
- [x] **G1 - Native adapter skeleton + capability enforcement** - shipped 2026-05-21. Added `bi-adapters/native/` with `BIAdapter` shell, native + BI capability declarations, renderer-only command vocabulary, forbidden-command rejection, registry loadability, no-embed readiness handling, and Vitest import-boundary guardrails. Validation: focused native/registry/readiness/vendor matrix **77/77**, full playground **1196/1196**, lint/build clean.
